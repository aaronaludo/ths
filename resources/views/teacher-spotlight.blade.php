...
<div class="container">
    <div class="p-5 text-center rounded-3 mt-5">
        <h1 class="color-kabarkadogs fw-bold hero-title position-relative display-3">Teacher Spotlight</h1>
    ...
    <div class="container">
      <div class="row featurette">
        <div class="col-lg-6 d-flex justify-content-center justify-content-md-start">
          <img
            src="{{ asset('storage/teacher_spotlight_images/' . $teacher_spotlight->image) }}"
            alt="logo2"
        ...
        <div class="col-lg-6">
          <h3 class="color-kabarkadogs-gold mt-3">{{ $teacher_spotlight->sub_title }}</h3>
          <h2 class="featurette-heading fw-normal lh-1 color-kabarkadogs">
            {{ $teacher_spotlight->title }}
          </h2>
          <p class="lead color-kabarkadogs mt-3">
            {{ $teacher_spotlight->description }}
          </p>
        </div>
        <hr class="featurette-divider" />
      </div>
