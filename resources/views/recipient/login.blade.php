            ...
            <div class="col-lg-12 d-flex justify-content-center">
              <div class="col-lg-5 col-sm-10 col-12 col-md-8 mt-5">
                <div id="login-container">
                  ...
                  @endif
                  <form action="{{ route('recipient.process.login') }}" method="post">
                    @csrf <!-- Add CSRF token -->
                    <div class="input-group mb-3 mt-4">
                      <span class="input-group-text"><i class="fa-solid fa-user"></i></span>
                      <input type="text" class="form-control" name="email" placeholder="Email" /> <!-- Add name attribute -->
                    </div>
                    ...
                    <div class="input-group mb-3 mt-4">
                      ...
                      <input type="password" class="form-control" name="password" placeholder="Password" /> <!-- Add name attribute -->
                    </div>
