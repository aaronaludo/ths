                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ route('recipient.track-document-reviews.index') }}">see more</a>
                            </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($shortTrackDocuments as $document)
                                            <tr>
                                                <td>{{ $document->track_document->id }}</td>
                                                <td>{{ $document->track_document->subject }}</td>
                                                <td>{{ date("F j, Y, g:i a", strtotime($document->track_document->created_at)) }}</td>
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="action-button"><a href="{{ route('recipient.track-document-reviews.view', $document->track_document->id) }}" title="View"><i class="fa-solid fa-eye"></i></a></div>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ route('recipient.request-document-reviews.index') }}">see more</a>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead class="table-light">
                                    ...
                                    <tbody>
                                        @foreach ($shortRequestDocuments as $document)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="action-button"><a href="{{ route('recipient.request-document-reviews.view', $document->id) }}" title="View"><i class="fa-solid fa-eye"></i></a></div>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
