        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="box">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="{{ route('recipient.account.update-profile') }}" method="post">
                                @csrf
                                <div class="mb-3 row">
                                    <label for="name" class="col-sm-12 col-lg-2 col-form-label">Name: <span class="required">*</span></label>
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ auth()->guard('recipient')->user()->name }}"/>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="email" class="col-sm-12 col-lg-2 col-form-label">Email: <span class="required">*</span></label>
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <input type="email" class="form-control" id="email" name="email" value="{{ auth()->guard('recipient')->user()->email }}"/>
                                    </div>
                                </div>
