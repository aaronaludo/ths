...
<div class="container">
    <div class="p-5 text-center rounded-3 mt-5">
        <h1 class="color-kabarkadogs fw-bold hero-title position-relative display-3">Academic Calendar</h1>
    ...
    <div class="container">
      <div class="row featurette">
        <div class="col-lg-6 d-flex justify-content-center justify-content-md-start">
          <img
            src="{{ asset('storage/academic_calendar_images/' . $academic_calendar->image) }}"
            alt="logo2"
        ...
        <div class="col-lg-6">
          <h3 class="color-kabarkadogs-gold mt-3">{{ $academic_calendar->sub_title }}</h3>
