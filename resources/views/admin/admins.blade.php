        ...
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a class="btn btn-primary" href="{{ route('admin.admins.add') }}">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="action-button">
                                                            <a href="{{ route('admin.admins.view', $user->id) }}" title="View">
                                                                <i class="fa-solid fa-eye"></i>
                                                            </a>
                                                        </div>
                                                        <div class="action-button"><a href="{{ route('admin.admins.edit', $user->id) }}" title="Edit"><i class="fa-solid fa-pencil"></i></a></div>
                                                        <div class="action-button">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form method="POST" action="{{ route('admin.admins.destroy', $user->id) }}">
                                                                @csrf
                                                                @method('DELETE')
